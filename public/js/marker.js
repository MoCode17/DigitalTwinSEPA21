computer_icon = L.divIcon({
  ...
  var computerMarkerPopup = L.popup().setContent('<img src="img/desktop-computer.png" alt=" " width="80" height="80"/><br/> <b>Computer</b><br/><b style="color:green;">On</b><br/><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked></div>');
  var lightMarkerPopup = L.popup().setContent('<img src="img/bulb.png" alt=" " width="80" height="80"/><br/> <b>Light</b>');
  var doorMarkerPopup = L.popup().setContent('<img src="img/door-open.png" alt=" " width="80" height="80"/><br/> <b>Door</b><br/><b style="color:green;">Open</b><br/><button type="button" class="btn btn-outline-danger btn-sm "style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">Close</button>');
  var sensor1MarkerPopup = L.popup().setContent('<img src="img/sensor.png" alt=" " width="80" height="80"/><br/> <b>Sensor 4</b><br/><b style="color:red;">Temperature</b> <b>19.0°C</b><br/><b style="color:blue;">Humidity</b> <b>49%</b><br/><button type="button" class="btn btn-outline-primary btn-sm "style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">View</button>');
  var sensor2MarkerPopup = L.popup().setContent('<img src="img/sensor.png" alt=" " width="80" height="80"/><br/> <b>Sensor 3</b><br/><b style="color:red;">Temperature</b> <b>19.1°C</b><br/><b style="color:blue;">Humidity</b> <b>50%</b><br/><button type="button" class="btn btn-outline-primary btn-sm "style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">View</button>');
  var sensor3MarkerPopup = L.popup().setContent('<img src="img/sensor.png" alt=" " width="80" height="80"/><br/> <b>Sensor 1</b><br/><b style="color:red;">Temperature</b> <b>19.0°C</b><br/><b style="color:blue;">Humidity</b> <b>49%</b><br/><button type="button" class="btn btn-outline-primary btn-sm "style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">View</button>');
  var sensor4MarkerPopup = L.popup().setContent('<img src="img/sensor.png" alt=" " width="80" height="80"/><br/> <b>Sensor 2</b><br/><b style="color:red;">Temperature</b> <b>19.1°C</b><br/><b style="color:blue;">Humidity</b> <b>50%</b><br/><button type="button" class="btn btn-outline-primary btn-sm "style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">View</button>');
  var thermostatMarkerPopup = L.popup().setContent('<img src="img/temperature.png" alt=" " width="80" height="80"/><br/> <b>Thermostat</b><br/><b style="color:red;"> Off<br/><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheck"></div>');
